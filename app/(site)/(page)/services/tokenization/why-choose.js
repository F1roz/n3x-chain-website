...
import { Features, tokenizationFeatures } from '@/app/(site)/utils/menu';
...
const FeaturesSection = () => {
    ...
    return (
        <div className='relative lg:my-[200px] my-[100px] font-poppins text-white'>
            ...
            <div>
                <SectionTitle title={"Trust us with your project"} des={"Why choose us for Tokenization"} />
                <div className="grid grid-cols-1 md:grid-cols-2 mt-10 gap-10 mb-[100px] max-w-[1230px] mx-auto ">
                    {tokenizationFeatures.map((feature, index) => (
                        <Choosecard
                            key={index}
                            url={feature?.url}
                            title={feature?.title}
