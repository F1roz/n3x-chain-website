      ...
      <div className="containers pt-32">
        <div className="flex items-center md:flex-row flex-col xl:gap-[237px] lg:gap-[100px] gap-16 xl:pb-[128px] lg:pb-[90px] pb-10">
          <div className="lg:w-1/2">
            <h3 className="heading2">Cloud Services</h3>
            <p className="lg:text-lg text-base text-white lg:mt-[26px] mt-4 line-clamp-5 mb-10">
              At Deepchain Labs, we use the latest cloud technologies, such as
              containerization, serverless computing, and microservices
              architecture. We provide your company the resources that it
              requires to advance rapidly, create services more successfully,
              and maintain your competitive edge in the digital age.
            </p>
