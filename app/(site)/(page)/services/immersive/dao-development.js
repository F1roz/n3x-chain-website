            ...
            <div className="containers pt-32">
                <div className="flex items-center md:flex-row flex-col xl:gap-[237px] lg:gap-[100px] gap-16 xl:pb-[128px] lg:pb-[90px] pb-10">
                    <div className="lg:w-1/2">
                        ...
                        <p className="lg:text-lg text-base text-white lg:mt-[26px] mt-4 line-clamp-5 mb-10">We at N3X Labs are committed to expanding the realm of the possible. Utilising the most recent technology and techniques, our team of talented designers and developers creates immersive experiences that are both aesthetically attractive and extraordinary in terms of functionality. We combine technical expertise with creativity to produce impactful immersive solutions.</p>
                        <Button name={'Get a Quote'} />
                    </div>

                    <Image
                        alt="lan"
                        src={'/immersive_landing.png'}
                        height={500}
                        width={500}
