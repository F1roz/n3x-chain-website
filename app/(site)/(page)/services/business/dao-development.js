      ...
      <div className="containers pt-32">
        <div className="flex items-center md:flex-row flex-col xl:gap-[237px] lg:gap-[100px] gap-16 xl:pb-[128px] lg:pb-[90px] pb-10">
          <div className="lg:w-1/2">
            <h3 className="heading2">Business Analysis </h3>
            <p className="lg:text-lg text-base text-white lg:mt-[26px] mt-4 line-clamp-5 mb-10">
              We turn raw data into actionable intelligence, enabling your
              organisation to make decisions that have a significant impact on
              your bottom line. Deepchain Labs makes sure that every choice you
              make is based on precise, data-supported suggestions, whether you
              are optimizing operations, improving customer experiences, or
              fine-tuning your strategic direction.
            </p>
