            ...
            <div className="containers pt-32">
                <div className="flex items-center md:flex-row flex-col xl:gap-[237px] lg:gap-[100px] gap-16 xl:pb-[128px] lg:pb-[90px] pb-10">
                    <div className="lg:w-1/2">
                        ...
                        <p className="lg:text-lg text-base text-white lg:mt-[26px] mt-4 line-clamp-5 mb-10">With N3X Chain, explore the world of cryptocurrency. We thrive on pushing boundaries and developing new paradigms in the realm of cryptocurrency, where change is the only constant. We create trends instead of following them. We remain your trusted partner for stepping into the cryptocurrency realm as the leaders in the industry.</p>
