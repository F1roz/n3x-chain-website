      ...
      <div className="containers pt-32">
        <div className="flex items-center md:flex-row flex-col xl:gap-[237px] lg:gap-[100px] gap-16 xl:pb-[128px] lg:pb-[90px] pb-10">
          <div className="lg:w-1/2">
            <h3 className="heading2">Application Development</h3>
            <p className="lg:text-lg text-base text-white lg:mt-[26px] mt-4 line-clamp-5 mb-10">
              Accelerated Development with Deepchain Labs. Utilise our swift
              application development services to remain flexible and responsive
              to market demands. We provide complete support from conception to
              implementation to help you promote your ideas more quickly and
