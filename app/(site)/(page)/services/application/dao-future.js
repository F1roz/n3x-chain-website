...
import { Daofeatures } from '@/app/(site)/utils/menu';
    ...
    return (
        <div className='relative my-[100px]'>
            ...
            <section className="text-center py-12 max-w-[1230px] mx-auto font-poppins text-white ">
                <SectionTitle title={"Empowering Communities through Decentralized Autonomy"} des={"Unlocking the Future with Our Expertise in Application Development"} />
