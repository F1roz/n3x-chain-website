            ...
            <div className="containers pt-32">
                <div className="flex items-center md:flex-row flex-col xl:gap-[237px] lg:gap-[100px] gap-16 xl:pb-[128px] lg:pb-[90px] pb-10">
                    <div className="lg:w-1/2">
                        ...
                        <p className="lg:text-lg text-base text-white lg:mt-[26px] mt-4 line-clamp-5 mb-10">N3X Chain's advanced Protocol Development service allows you to take the lead in blockchain innovation. Our skilled team creates custom scalable protocols to unlock blockchain potential, enabling seamless integration and security for enterprises. Join us as we discover the infinite possibilities of blockchain technology.</p>
                        <Button name={'Get a Quote'} />
                    </div>

                    <Image
                        alt="lan"
                        src={'/protocolhero.png'}
                        height={500}
                        width={500}
