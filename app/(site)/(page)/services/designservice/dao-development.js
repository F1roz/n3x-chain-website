            ...
            <div className="containers pt-32">
                <div className="flex items-center md:flex-row flex-col xl:gap-[237px] lg:gap-[100px] gap-16 xl:pb-[128px] lg:pb-[90px] pb-10">
                    <div className="lg:w-1/2">
                        ...
                        <p className="lg:text-lg text-base text-white lg:mt-[26px] mt-4 line-clamp-5 mb-10">When you choose Deepchain Labs for your Design Service needs, you're choosing a partner that values collaboration and creativity. We listen to your ideas and requirements, infuse them with our expertise, and deliver designs that not only meet but exceed your business goals and objectives. With our Design Service, you'll have the visual assets you need to stand out in a crowded marketplace and leave a lasting impression on your audience.</p>
                        <Button name={'Get a Quote'} />
                    </div>

                    <Image
                        alt="lan"
                        src={'/desing_landing.png'}
                        height={500}
                        width={500}
