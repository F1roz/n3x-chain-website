            ...
            <div className="containers pt-32">
                <div className="flex items-center md:flex-row flex-col xl:gap-[237px] lg:gap-[100px] gap-16 xl:pb-[128px] lg:pb-[90px] pb-10">
                    <div className="lg:w-1/2">
                        ...
                        <p className="lg:text-lg text-base text-white lg:mt-[26px] mt-4 line-clamp-5 mb-10">N3X Chain NFT marketplaces go beyond transactions; they are vibrant communities for collectors, creators, and enthusiasts. We are innovating with social features, gamification, and more to create engaging, inclusive, and rewarding experiences, making NFT trading about more than just buying and selling.</p>
