...
import { nftMarketDaofeatures } from '@/app/(site)/utils/menu';
    ...
    return (
        <div className='relative my-[100px]'>
            ...
            <section className="text-center py-12 max-w-[1230px] mx-auto font-poppins text-white ">
                <SectionTitle title={"Where Creativity Meets Collectibility: Your NFT Destination"} des={"Unlocking the Future with Our Expertise in NFT Marketplace Development"} />
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-10 gap-8 px-3">
                    {nftMarketDaofeatures.map((feature, index) => (
