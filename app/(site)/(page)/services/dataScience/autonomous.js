'use client'
import { AutonomousfeaturesDataScience } from '@/app/(site)/utils/menu';
        ...
        <div className='relative my-[100px]'>
            ...
            <section className="text-center py-12 container mx-auto font-poppins text-white  px-3">
                <div className='flex flex-col items-center relative'>
                    <h2 className="lg:text-xl text-lg font-bold mb-6 text-center text-white">True Experts in Data Science</h2>
                    <div className='w-[200px] h-[2px] absolute top-8   bg-white mx-auto'></div>
                    <h2 className="lg:text-xl text-lg font-bold mb-6 text-center text-white">Pioneering Decentralized Autonomous Organizations (Data Science)</h2>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-10 gap-8">
                    {AutonomousfeaturesDataScience.map((feature, index) => (
