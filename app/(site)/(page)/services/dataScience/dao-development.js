            ...
            <div className="containers pt-32">
                <div className="flex items-center md:flex-row flex-col xl:gap-[237px] lg:gap-[100px] gap-16 xl:pb-[128px] lg:pb-[90px] pb-10">
                    <div className="lg:w-1/2">
                        ...
                        <p className="lg:text-lg text-base text-white lg:mt-[26px] mt-4 line-clamp-5 mb-10">By selecting Deepchain Labs for your data science needs, you will have a dependable partner who is dedicated to providing useful information and measurable outcomes. Stay ahead of the curve, empower your organization with data-driven decision-making, and realize the full potential of your data assets.</p>
                        <Button name={'Get a Quote'} />
                    </div>

                    <Image
                        alt="lan"
                        src={'/design_service_landing.png'}
                        height={500}
                        width={500}
