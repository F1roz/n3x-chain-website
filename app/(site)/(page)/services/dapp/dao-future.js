...
import { DappFeatures } from '@/app/(site)/utils/menu';
    ...
    return (
        <div className='relative my-[100px]'>
            ...
            <section className="text-center py-12 max-w-[1230px] mx-auto font-poppins text-white ">
                <SectionTitle title={"Building Next-Gen Decentralized Applications"} des={"Unlocking the Future with Our Expertise in DApp Development"} />
