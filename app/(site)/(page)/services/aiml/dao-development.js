      ...
      <div className="containers pt-32">
        <div className="flex items-center md:flex-row flex-col xl:gap-[237px] lg:gap-[100px] gap-16 xl:pb-[128px] lg:pb-[90px] pb-10">
          <div className="lg:w-1/2">
            <h3 className="heading2">AI/ML Services</h3>
            <p className="lg:text-lg text-base text-white lg:mt-[26px] mt-4 line-clamp-5 mb-10">
              N3X Chain is committed to establishing AI/ML technological
              advancement within your company. We provide comprehensive AI/ML
              services, including thorough instruction and tutorials, to provide
              your team with the knowledge and abilities required for efficient
              AI/ML use. Our dedication extends to ongoing support and
              maintenance, ensuring that your AI/ML solutions evolve effectively
