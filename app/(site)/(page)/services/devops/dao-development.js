      ...
      <div className="containers pt-32">
        <div className="flex items-center md:flex-row flex-col xl:gap-[237px] lg:gap-[100px] gap-16 xl:pb-[128px] lg:pb-[90px] pb-10">
          <div className="lg:w-1/2">
            <h3 className="heading2">DevOps </h3>
            <p className="lg:text-lg text-base text-white lg:mt-[26px] mt-4 line-clamp-5 mb-10">
              With N3X Labs as your DevOps partner, you can expect continuous
              integration and continuous delivery (CI/CD) pipelines that ensure
              rapid and consistent software releases. Our professionals use
              thorough testing and monitoring procedures that enable early
              problem identification and resolution, hence ensuring the
              dependability of your applications. Get a Quote
            </p>
