            ...
            <div className="containers pt-32">
                <div className="flex items-center md:flex-row flex-col xl:gap-[237px] lg:gap-[100px] gap-16 xl:pb-[128px] lg:pb-[90px] pb-10">
                    <div className="lg:w-1/2">
                        ...
                        <p className="lg:text-lg text-base text-white lg:mt-[26px] mt-4 line-clamp-5 mb-10">For the decentralized future, N3X Chain is modernizing wallets. Our wallets offer more than just storage; they act as routes to a world of financial control, exclusive content access, and involvement in blockchain governance. To build the financial future, we are developing innovative, user-friendly features like multi-chain integration and DApp compatibility.</p>
