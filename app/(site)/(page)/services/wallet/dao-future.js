...
import { walletDaofeatures } from '@/app/(site)/utils/menu';
    ...
    return (
        <div className='relative my-[100px]'>
            ...
            <section className="text-center py-12 max-w-[1230px] mx-auto font-poppins text-white ">
                <SectionTitle title={"Fortify Your Wealth, Simplify Your Transactions"} des={"Unlocking the Future with Our Expertise inWallet Development"} />
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-10 gap-8 px-3">
                    {walletDaofeatures.map((feature, index) => (
