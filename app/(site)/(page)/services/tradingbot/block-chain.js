...
const BlockChain = () => {
    ...
    return (
        <div className='mt-[100px] mb-[200px] relative'>
            <div className='max-w-[1230px] mx-auto font-poppins text-white px-3'>
                <SectionTitle title={"Unleashing the power of the crowd with cutting-edge blockchain!"} des={"Unleashing the power of the crowd with cutting-edge blockchain!"} />
