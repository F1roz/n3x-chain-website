            ...
            <div className="containers pt-32">
                <div className="flex items-center md:flex-row flex-col xl:gap-[237px] lg:gap-[100px] gap-16 xl:pb-[128px] lg:pb-[90px] pb-10">
                    <div className="lg:w-1/2">
                        ...
                        <p className="lg:text-lg text-base text-white lg:mt-[26px] mt-4 line-clamp-5 mb-10">Experience automated trading with n3x chain advanced Trading Bot Development. Unlock smarter, more efficient trades using innovative algorithms to navigate the dynamic trading landscape. Elevate your trading strategies with our expertise and take investing to new heights!</p>
