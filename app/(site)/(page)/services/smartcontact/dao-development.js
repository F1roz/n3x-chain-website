            ...
            <div className="containers pt-32">
                <div className="flex items-center md:flex-row flex-col xl:gap-[237px] lg:gap-[100px] gap-16 xl:pb-[128px] lg:pb-[90px] pb-10">
                    <div className="lg:w-1/2">
                        ...
                        <p className="lg:text-lg text-base text-white lg:mt-[26px] mt-4 line-clamp-5 mb-10">N2X Chain  specializes in designing and deploying dapps on self-executing smart contracts for Hyperledger, EOS, and Ethereum blockchains. Our smart contract development services automate operations, speed up procedures, optimize workflows, and enhance security.</p>
                        <Button name={'Get a Quote'} />
                    </div>

                    <Image
                        alt="lan"
                        src={'/smartcontact.png'}
                        height={500}
                        width={500}
